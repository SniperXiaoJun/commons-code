...
/**
 * 参数验证类，改造自goole的com.google.common.base.Preconditions
 * @author fupf
 */
public final class Preconditions {
    ...
    public static void checkNotEmpty(String checking, String field) {
        if (checking == null || "".equals(checking)) {
            throw new IllegalArgumentException(field + CAN_NOT_NULL_EMPTY);
        }
    }

    public static void checkNotEmpty(Collection<?> checking, String field) {
    ...
    public static void checkNotAllNull(Map<String, ?> map, String... names) {
        for (String name : names) {
            if (!ObjectUtils.isEmpty(map.get(name))) return;
        }
        throw new IllegalArgumentException();
    }
}
