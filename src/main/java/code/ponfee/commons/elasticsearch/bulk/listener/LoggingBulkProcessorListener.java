package code.ponfee.commons.elasticsearch.bulk.listener;
...
public class LoggingBulkProcessorListener implements BulkProcessor.Listener {
    ...
    public void beforeBulk(long executionId, BulkRequest request) {
        logger.debug("ExecutionId = {}, Actions = {}, Estimated Size = {}", executionId, request.numberOfActions(), request.estimatedSizeInBytes());
    }
