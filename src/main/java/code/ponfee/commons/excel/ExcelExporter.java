...
public class ExcelExporter {
     ...
     * @return
     */
    public static Workbook write(List<?>... sheetDataListArr) {
     ...
     */
    public static void write(String filePath, List<?>... sheetDataListArr) {
        // workbook
        Workbook workbook = write(sheetDataListArr);
     ...
     * @return
     */
    public static byte[] export(List<?>... sheetDataListArr) {
        // workbook
        Workbook workbook = write(sheetDataListArr);
        ...
        for (int dataIndex = 0; dataIndex < sheetDataList.size(); dataIndex++) {
            ...
            for (int i = 0; i < fields.size(); i++) {
                ...
                try {
                    ...
                    String fieldValueString = FieldReflections.formatValue(field, fieldValue);
