...
public class EncryptTester {
    ...
    public static void main(String[] args) {
        ...
        coder = SymmetricCryptorBuilder.newBuilder(Algorithm.AES).key(nextBytes(16)).mode(Mode.CBC).padding(Padding.X9_23Padding).ivParameter(nextBytes(16)).provider(bc).build();
