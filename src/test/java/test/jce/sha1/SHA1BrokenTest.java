...
public class SHA1BrokenTest {
    ...
    public @Test void test2() {
        ...
        System.out.println(Hex.encodeHexString(HashUtils.digest(HashAlgorithms.SHA3_256, Providers.BC, pdf2)));
        System.out.println(Hex.encodeHexString(HashUtils.digest(HashAlgorithms.KECCAK256, Providers.BC, pdf2)));
        System.out.println();

        System.out.println(Hex.encodeHexString(HashUtils.digest(HashAlgorithms.SHA3_512, Providers.BC, pdf2)));
