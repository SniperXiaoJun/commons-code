...
public class NodeTreeTest {
    ...
    public void test1() {
        ...
        list.add(new NamedNode<String>("100012", "100010", 4, true, "nid100012"));
        list.add(new NamedNode<String>("100020", "100000", 1, false, "nid100020"));
        list.add(new NamedNode<String>("100021", "100020", 5, true, "nid100020"));
        list.add(new NamedNode<String>("100022", "100020", 3, false, "nid100022"));

        list.add(new NamedNode<String>("200000", null, 2, true, "nid200000"));

        list.add(new NamedNode<String>("300000", null, 4, true, "nid300000"));
        ...
        list.add(new NamedNode<String>("500000", null, 3, false, "nid500000"));
        list.add(new NamedNode<String>("500010", "500000", 3, true, "nid500010"));
        list.add(new NamedNode<String>("500011", "500010", 3, true, "nid500011"));
